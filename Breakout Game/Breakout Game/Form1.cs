 ...
 * 
 * Programmers: Shemmar Higgins and Ian Francis
 * 
    ...
    public partial class GameClient : Form
    {
        ...
        private void tmrGame_Tick(object sender, EventArgs e)
        {
            ...
            if (picBall.Top <= 24)
            {
                ...
                //redraw ball
                Position = new Vector2(picBall.Left, (25));
                Position += Velocity;
                picBall.Left = (int)Position.X;
                picBall.Top = (int)Position.Y;
            }
            ...
            if (PlayerLives == 0)
            {
                ...
                MessageBox.Show("You Lost! Press Ok to restart");
                ForceClose();
            }
        ...
        //Removes brick when collision with ball occurs
        ...
        //Hides bricks at the start of game so it does not overlap with the welcome text
        ...
        //Shows the bricks once the timer starts so they are no longer hidden
        ...
        //Restarts the application to initialize bricks again
        ...
        {
            //ignore this, deleting it would break the form
        }//END OF METHOD
        ...
        //These were handled through hotkeys found in tutorial.
